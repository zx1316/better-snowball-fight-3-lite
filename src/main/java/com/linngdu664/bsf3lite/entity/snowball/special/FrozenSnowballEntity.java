...
public class FrozenSnowballEntity extends AbstractBSFSnowballEntity {
    ...
    public FrozenSnowballEntity(Level pLevel, double pX, double pY, double pZ, RegionData region) {
        super(EntityRegistry.FROZEN_SNOWBALL.get(), pX, pY, pZ, pLevel, ItemRegistry.FROZEN_SNOWBALL.toStack(),
    ...
    public FrozenSnowballEntity(LivingEntity pShooter, Level pLevel, ILaunchAdjustment launchAdjustment, RegionData region) {
        super(EntityRegistry.FROZEN_SNOWBALL.get(), pShooter, pLevel, ItemRegistry.FROZEN_SNOWBALL.toStack(),
