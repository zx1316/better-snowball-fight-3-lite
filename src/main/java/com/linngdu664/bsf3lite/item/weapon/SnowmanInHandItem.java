...
public class SnowmanInHandItem extends Item {
    ...
    public void appendHoverText(ItemStack itemStack, TooltipContext context, TooltipDisplay display, Consumer<Component> builder, TooltipFlag tooltipFlag) {
        ...
        builder.accept(Component.translatable("snowman_in_hand.tooltip").withStyle(ChatFormatting.GRAY));
        builder.accept(Component.translatable("snowman_in_hand1.tooltip", options.keyShift.getTranslatedKeyMessage()).withStyle(ChatFormatting.DARK_GRAY));
        builder.accept(Component.translatable("snowman_in_hand2.tooltip", options.keyUse.getTranslatedKeyMessage()).withStyle(ChatFormatting.DARK_GRAY));
    }
}
