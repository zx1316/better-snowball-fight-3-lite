...
public abstract class AbstractSnowStorageSnowballItem extends AbstractBSFSnowballItem {
    ...
    public AbstractSnowStorageSnowballItem(String id, Rarity rarity, SnowballProperties snowballProperties) {
        super(id, rarity, snowballProperties.allowLaunchTypeFlag(HAND_TYPE_FLAG));
    }
    ...
    public void addMainTips(Consumer<Component> builder) {
        builder.accept(Component.translatable("snow_storage_snowball.tooltip").withStyle(ChatFormatting.GRAY));
    }
}
