...
import com.linngdu664.bsf3lite.entity.snowball.nomal.IronSnowballEntity;
...
public class IronSnowballItem extends AbstractBSFSnowballItem implements ProjectileItem {
    public IronSnowballItem() {
        super("iron_snowball", Rarity.COMMON, new SnowballProperties()
                .idForTank(5)
    ...
    public void addMainTips(Consumer<Component> builder) {
        builder.accept(Component.translatable("iron_snowball.tooltip").withStyle(ChatFormatting.GRAY));
    }
}
