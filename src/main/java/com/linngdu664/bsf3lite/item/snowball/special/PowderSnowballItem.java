...
import com.linngdu664.bsf3lite.entity.snowball.special.PowderSnowballEntity;
...
public class PowderSnowballItem extends AbstractBSFSnowballItem implements ProjectileItem {
    public PowderSnowballItem() {
        super("powder_snowball", Rarity.UNCOMMON, new SnowballProperties()
                .idForTank(10)
    ...
    public void addMainTips(Consumer<Component> builder) {
        builder.accept(Component.translatable("powder_snowball.tooltip").withStyle(ChatFormatting.GRAY));
    }
}
