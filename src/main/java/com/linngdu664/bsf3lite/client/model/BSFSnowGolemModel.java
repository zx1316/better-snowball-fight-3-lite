package com.linngdu664.bsf3lite.client.model;// Made with Blockbench 4.4.1
...
public class BSFSnowGolemModel extends EntityModel<BSFSnowGolemRenderState> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Main.makeMyIdentifier("bsf_snow_golem"), "main");
