...
public class Textures {
    ...
    public static final GuiSubSprite TWEAKER_LOCATOR_GUI = new GuiSubSprite(TWEAKER_FRAME, 1, 0, 22, 82);
    ...
    public static final GuiSubSprite GOLEM_LOCATOR_GUI = new GuiSubSprite(TWEAKER_FRAME, 47, 0, 22, 82);
